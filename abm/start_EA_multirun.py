...
def EA_runner():
    ...
    # for x in range(20):
    #     set_env_var('RESOURCE_POS', (400,400))
    #     set_env_var('PERCEP_ANGLE_NOISE', .05)
    #     set_env_var('ACTION_NOISE', 0)
    #     set_env_var('RNN_HIDDEN_SIZE', 2)
    ...
    # for x in range(20):
    #     set_env_var('RESOURCE_POS', (400,400))
    #     set_env_var('PERCEP_ANGLE_NOISE', .1)
    #     set_env_var('ACTION_NOISE', 0)
    #     set_env_var('RNN_HIDDEN_SIZE', 2)
    ...
    # for x in range(20):
    #     set_env_var('RESOURCE_POS', (400,400))
    #     set_env_var('PERCEP_ANGLE_NOISE', .15)
    #     set_env_var('ACTION_NOISE', 0)
    #     set_env_var('RNN_HIDDEN_SIZE', 2)
    ...
    # for x in range(20):
    #     set_env_var('RESOURCE_POS', (400,400))
    #     set_env_var('PERCEP_ANGLE_NOISE', .2)
    #     set_env_var('ACTION_NOISE', 0)
    #     set_env_var('RNN_HIDDEN_SIZE', 2)
